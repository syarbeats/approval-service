...
import com.mitrais.cdc.approvalmicroservice.security.jwt.JwtConfigurer;
import com.mitrais.cdc.approvalmicroservice.services.UserDetailsServices;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/update-chart**").permitAll()
                .antMatchers("/update-chart-v2**").permitAll()
